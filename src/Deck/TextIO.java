...
class TextIO {
     ...
     * standard input stream.
     */
    private static void readStream(Reader inputStream) {
        if (inputStream == null)
            readStandardInput();
        else {
     ...
     * standard output stream.
     */
    private static void writeStream(PrintWriter outputStream) {
        if (outputStream == null)
            writeStandardOutput();
        else {
            out = outputStream;
     ...
     */
    private static void put(Object x, int minChars) {
        if (minChars <= 0)
            out.print(x);
        else
